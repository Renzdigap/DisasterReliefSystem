...
public class VolunteerPortalPanel extends JPanel {
    ...
    public VolunteerPortalPanel() {
        ...
        JLabel lblSubBrand = new JLabel("Field Volunteer Portal");
        ...
        addNavGroup(sidebar, "OPERATIONS");
        addNavItem(sidebar, "Dashboard", "Current status and active alerts", new disasterrelief.gui.panels.PublicDashboardPanel());
        addNavItem(sidebar, "My Deliveries", "Assigned fleet logistics and deliveries", new disasterrelief.gui.panels.MyDeliveriesPanel());

        addNavGroup(sidebar, "SETTINGS");
        addNavItem(sidebar, "Profile", "Update availability and contact info", new disasterrelief.gui.panels.VolunteerProfilePanel());
        ...
        lblPageSubtitle = new JLabel("Current status and active alerts");
