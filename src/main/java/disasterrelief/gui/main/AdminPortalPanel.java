...
public class AdminPortalPanel extends JPanel {
    ...
    public AdminPortalPanel() {
        ...
        JLabel lblSubBrand = new JLabel("Admin Operations");
        ...
        addNavGroup(sidebar, "SYSTEM CORE");
        addNavItem(sidebar, "Dashboard", "Real-time incident and resource overview", new disasterrelief.gui.panels.DashboardPanel());

        addNavGroup(sidebar, "RELIEF OPERATIONS");
        addNavItem(sidebar, "Disaster Events", "Active and monitored disaster zones", new disasterrelief.gui.panels.DisasterEventsPanel());
        addNavItem(sidebar, "Relief Requests", "Evacuee & community request processing", new disasterrelief.gui.panels.RequestsPanel());
        addNavItem(sidebar, "Deliveries", "Fleet dispatch and delivery tracking", new disasterrelief.gui.panels.DeliveriesPanel());

        addNavGroup(sidebar, "SUPPLY & DONATIONS");
        addNavItem(sidebar, "Donations", "In-kind & monetary contribution split ledger", new disasterrelief.gui.panels.DonationsPanel());
        addNavItem(sidebar, "Inventory", "Real-time stock levels and catalog items", new disasterrelief.gui.panels.ReliefGoodsPanel());

        addNavGroup(sidebar, "STAKEHOLDERS");
        addNavItem(sidebar, "Volunteers", "Field responders and transport availability", new disasterrelief.gui.panels.VolunteersPanel());
        addNavItem(sidebar, "Organizations", "Relief partner agencies and NGOs", new disasterrelief.gui.panels.OrganizationsPanel());

        addNavGroup(sidebar, "ADMINISTRATION");
        addNavItem(sidebar, "Users", "System accounts, credentials and role security", new disasterrelief.gui.panels.UsersPanel());
        addNavItem(sidebar, "Reports", "Aggregated audits and transparency statistics", new disasterrelief.gui.panels.ReportsPanel());
        ...
        lblPageSubtitle = new JLabel("Real-time incident and resource overview");
